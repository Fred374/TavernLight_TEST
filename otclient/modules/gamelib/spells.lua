...
SpellInfo = {
  ['Default'] = {
    ...
    ['Winter'] =                   {id = 179, words = 'frigo',                 exhaustion = 0,  premium = false, type = 'Instant', icon = 'eternalwinter',          mana = 1,      level = 1,  soul = 0, group = {[1] = 0},                  vocations = {1, 2, 3, 4, 5, 6, 7, 8}},
